...
import { HistoriesByDayTable } from "@/components/histories-components/histories-by-day-table";
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const handlegetSales = async (data: DateRangeValues) => {
        try {
          setIsSending(true);
          let url = urlConstructor(data, 'histories/by-day')
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-10 pb-10">
        ...
        <ViewTitle text="LISTADO DE VENTAS POR DIA" />

        <HistoriesByDayTable records={sales} isLoading={isSending} />
