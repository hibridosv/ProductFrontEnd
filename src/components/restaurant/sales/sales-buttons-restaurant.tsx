    ...
    <div className="border rounded-md shadow-md m-2">
        ...
        <div className='flex justify-center'>
                <Tooltip animation="duration-300" content={
                    ...
                    <div className='font-semibold text-slate-700 py-2 px-4 hover:bg-slate-100 clickeable' onClick={isSending ? ()=>{} : ()=>onClickOrder(OptionsClickOrder.printPreAccount)}> Imprimir pre cuenta</div>
                    { selectType == 2 &&
