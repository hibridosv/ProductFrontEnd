    ...
    >
      <Menu>
        ...
        <SubMenu label="Historiales" icon={<FaHistory />}>
          ...
          <MenuItem component={<Link className="text-sm" href="/histories/transfers" />}>Listado de Transferencias </MenuItem>
        </SubMenu>
        ...
        <SubMenu label="Configuraciones" icon={<HiOutlineChartSquareBar />}>
          ...
          <MenuItem component={<Link className="text-sm" href={handlePermission("config-transfers", "/config/transfers")} />}>Tranferencias</MenuItem>
